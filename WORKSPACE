...
http_archive(
    name = "hmm",
    build_file = "@transatlancair//third_party:BUILD.hmm",
...
http_archive(
    name = "hmstl",
    build_file = "@transatlancair//third_party:BUILD.hmstl",
...
http_archive(
    name = "libtrix",
    build_file = "@transatlancair//third_party:BUILD.libtrix",
